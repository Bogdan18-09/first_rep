...
def new_list_for_happy():
    ...
    #     Выбор типа данных для dict key
        if output_index_type==4:
            select_type_key=int(input(f'Выберите тип данных для ключа 1-int 2-str 3-list 4 dick  : '))
            if select_type_key==1:
                _key=int(input('Введите ваше число : '))
            if select_type_key == 2:
                _key=input('Enter youre string : ')
            if select_type_key==4:
                print('are you stupid ')
                question=int(input('1- Yes 2 - No  '))
                if question == 2: print('it\'s False ahahahah')
            if select_type_key == 3:
                _key =list(input('Enter youre list : '))

            #     выбор типа данных для value
            select_value_type=int(input('enter types of value 1-int  2-str  3-list  4-dick '))
            ...
            if select_value_type ==4 :
                question2=int(input('are you stuped also ? 1 -yehh 2 - no i miss '))
                if question2==1 or 2:print ('it\'s bed ')
                break
